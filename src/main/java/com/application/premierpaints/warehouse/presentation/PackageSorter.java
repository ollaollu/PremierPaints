 ...
 * @author ollaollu
 */
public class PackageSorter implements Comparator<Productionpackage> {
 
    private String sortField;
     
    private SortOrder sortOrder;
     
    public PackageSorter(String sortField, SortOrder sortOrder) {
        this.sortField = sortField;
        this.sortOrder = sortOrder;
    }

    @Override
    public int compare(Productionpackage o1, Productionpackage o2) {
        try {
